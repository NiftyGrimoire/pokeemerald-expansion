...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_SLURPUFF}),
    },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SLIGGOO}
                            #if P_HISUIAN_FORMS
                                ,{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_SLIGGOO_HISUI}
                            #endif
                            ),
    },
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG}
                            #if P_HISUIAN_FORMS
                                ,{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_AVALUGG_HISUI}
                            #endif
                            ),
    },
