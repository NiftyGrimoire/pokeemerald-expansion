...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_STEELIX}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_MOON_STONE, SPECIES_RHYPERIOR}),
    #endif
    },
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CHANSEY, CONDITIONS({IF_NOT_TIME, TIME_NIGHT},{IF_HOLD_ITEM, ITEM_OVAL_STONE})},
                                {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_CHANSEY}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_MR_MIME, CONDITIONS({IF_NOT_REGION, REGION_GALAR})}
                            #if P_GALARIAN_FORMS
                                ,{EVO_LEVEL, 32, SPECIES_MR_MIME_GALAR, CONDITIONS({IF_REGION, REGION_GALAR})}
                            #endif
                            ),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .evolutions = EVOLUTION(
                            #if P_GEN_2_CROSS_EVOS
                                {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_SCIZOR}
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ELECTIVIRE}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_FIRE_STONE, SPECIES_MAGMORTAR}),
    #endif
    },
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                ,{EVO_LEVEL, 30, SPECIES_SYLVEON}
                            #endif
                            #if P_GEN_2_CROSS_EVOS
                                ,{EVO_LEVEL, 30, SPECIES_ESPEON},
                                {EVO_LEVEL, 30, SPECIES_UMBREON}
                            #endif
                            #if P_GEN_4_CROSS_EVOS
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_DAWN_STONE, SPECIES_PORYGON2}),
    #endif
    },
