...
TEST("Learnset weights favor appropriate damaging move power by level")
{
    ...
    u32 earlySelfDestruct = GetRandomizerMoveWeightForLevel(SPECIES_CHARMANDER, MOVE_SELF_DESTRUCT, 5);
    u32 earlyExplosion = GetRandomizerMoveWeightForLevel(SPECIES_CHARMANDER, MOVE_EXPLOSION, 5);
    u32 earlyVCreate = GetRandomizerMoveWeightForLevel(SPECIES_CHARMANDER, MOVE_V_CREATE, 5);
